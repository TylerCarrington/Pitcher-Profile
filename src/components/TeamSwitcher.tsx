  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-100 border border-slate-700 text-xs font-semibold transition"
      >
        ...
        >
              ...
              teams.map((team) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full px-3 py-2.5 text-left text-xs flex items-center justify-between gap-2.5 hover:bg-slate-50 transition ${
          ...
          <div className="p-1.5 border-t border-slate-100 bg-slate-50/40 space-y-1 mt-1">
            <button
              ...
              className="w-full px-3 py-2 text-xs font-semibold text-emerald-700 hover:bg-emerald-50 rounded-lg text-left transition flex items-center gap-2"
            >
            ...
            <button
              ...
              className="w-full px-3 py-2 text-xs font-semibold text-sky-700 hover:bg-sky-50 rounded-lg text-left transition flex items-center gap-2"
            >
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-3">
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100">
                ...
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-bold rounded-lg bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white shadow-xs transition"
                >
                  Create Team
                </button>
              </div>
